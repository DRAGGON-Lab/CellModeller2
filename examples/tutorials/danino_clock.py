"""Typed core of SimBOL's Danino quorum-sensing clock and trap geometry.

This port keeps the LuxI/AiiA/GFP oscillator, extracellular AHL coupling,
and the finite trap.  The SimBOL source's custom nutrient field reaction is
intentionally outside this model; see the accompanying tutorial notes.
"""
...
def build(context: ModelContext) -> NativeController:
    ...
    state: dict[str, JSONValue] = {"scope": "core-clock-with-trap"}
