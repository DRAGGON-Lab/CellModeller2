...
| P0 | Plane and sphere constraints | `CLBacterium.cl` | typed constraint records; no sentinel cell IDs | CPU and native Metal geometry/mechanics conformant; CUDA port pending |
