...
| P2 | Interactive viewer | PyQt/OpenGL GUI | separate consumer of snapshots; no engine ownership | legacy GUI audited and scene/controller boundary specified; scene projection pending |
