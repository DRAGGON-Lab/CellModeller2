...
| P0 | Batch execution | batch scripts | `cm2 run`, backend/device/seed selection | deterministic construction, collision preflight, periodic checkpoints, provenance, and bounded cell-count stopping implemented; data-only run manifests pending |
