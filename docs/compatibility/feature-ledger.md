...
| P2 | Interactive viewer | PyQt/OpenGL GUI | separate consumer of snapshots; no engine ownership | strict scene v1 projection implemented with backend-neutral rod/grid conformance; read-only viewer pending |
