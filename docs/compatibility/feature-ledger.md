...
| P0 | Coupled cell/grid rates | signal integrators | device-resident sample, rate, scatter, and update | typed plan, CPU reference, conservation tests, and exact checkpoint state implemented; native Metal/CUDA pending |
