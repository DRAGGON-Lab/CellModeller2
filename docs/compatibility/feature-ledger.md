...
| P1 | Legacy Python model adapter | module regulator | adapter for maintained `setup/init/update/divide` models | callback lifecycle implemented; setup facade and adapter checkpoints pending |
